...
?>
<div class="walkerwp-wraper banner-layout banner-layout-2 <?php echo esc_attr($banner_layout);?>">
	<div class="walkerwp-container">
		<div class="walkerwp-grid-3 left-grid-posts">
			<?php
...
<div class="swiper-container walkerpress-featured-slider-one">
		...
		<div class="walkerwp-grid-3 right-grid-posts">
			<?php
				$featured_grid_cat = get_theme_mod('walkerpress_featured_grid_category');
				if(!empty($featured_grid_cat)){
					$featured_args = array(
