<header id="masthead" class="site-header header-layout-2">
		...
		<div class="walkerwp-wraper main-header no-gap">
			...
			<div class="walkerwp-container">
				<?php
					$header_two_current_ads_postion = get_theme_mod('walkerpress_heaer_ads_postion','header-ads-below-brand');
					if($header_two_current_ads_postion == 'header-ads-above-brand'){
						walkerpress_header_ads_section();
					}
					walkerpress_branding();
					if($header_two_current_ads_postion == 'header-ads-below-brand'){
						walkerpress_header_ads_section();
					}
				?>
